...
export default defineAppConfig({
  ui: {
    ...
    button: {
      ...
      color: {
        primary: {
          outline: "hover:dark:bg-white hover:dark:text-black border dark:disabled:bg-[#383838] dark:disabled:text-[#8A8A8A] dark:disabled:border-none",
          solid:
    ...
    tabs: {
      list: {
        ...
        marker: {
          rounded: 'rounded-[2.5rem]',
          background: 'dark:bg-gradient-to-r dark:from-turquoise-100 dark:to-green'
        },
        tab: {
